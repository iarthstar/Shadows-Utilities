...
(function($PS) {
  ...
  var ImageStyle = function (x) {
      return x;
  };
  var GroupStyle = function (x) {
      return x;
  };
  var ImageLayer = function (x) {
      return x;
  };
  var TextLayer = function (x) {
      return x;
  };
...
(function($PS) {
  ...
  var setPropsForLayerID = function (dictEncode) {
      return function (id) {
          return function (path) {
              return function (val) {
...
(function($PS) {
  ...
  var Foreign_Class = $PS["Foreign.Class"];
  var Sketch_Utils = $PS["Sketch.Utils"];
  var setGlobalSettingForKey = function (dictEncode) {
      return function (key) {
          return function (val) {
  ...
  var globalSettingForKey = function (dictDecode) {
...
(function($PS) {
  ...
  var _style = function (dictNewtype) {
      return function (dictFunctor) {
  ...
  var _shadows = function (dictNewtype) {
      return function (dictFunctor) {
          return Optic_Lens.lens((function () {
  ...
  var copyOrCutShadows = function (action) {
      var performAction = function (dictEncode) {
  ...
  var pasteOrRemoveShadows = function (action) {
